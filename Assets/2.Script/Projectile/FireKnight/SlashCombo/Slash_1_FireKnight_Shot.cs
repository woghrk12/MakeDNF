...
public partial class Slash_1_FireKnight
{
    public class Shot : ProjectileState
    {
        #region Variables

        private Slash_1_FireKnight stateController = null;

        #endregion Variables

        #region Constructor

        public Shot(Slash_1_FireKnight stateController) : base(stateController)
        {
