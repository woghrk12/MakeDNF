...
public partial class Slash_2_FireKnight
{
    public class Shot : ProjectileState
    {
        #region Variables

        private Slash_2_FireKnight stateController = null;

        #endregion Variables

        #region Constructor

        public Shot(Slash_2_FireKnight stateController) : base(stateController)
        {
