...
public partial class Slash_3_FireKnight
{
    public class Shot : ProjectileState
    {
        #region Variables

        private Slash_3_FireKnight stateController = null;

        #endregion Variables

        #region Constructor

        public Shot(Slash_3_FireKnight stateController) : base(stateController)
        {
